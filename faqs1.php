...
<div id="container">
	...
	<br />
		...
		<div id="content">
			...
			<h4>Do you ship?</h4>
					<p style="text-indent:60px;">Yes, if you are living in another country then we
offer ship for you</p>
				<hr>
					<h4>Do you Deliver?</h4>
						<p style="text-indent:60px;">Yes.</p>
				<hr>
					<h4>When will I get my orders?</h4>
						<p style="text-indent:60px;">We will ship your product 2-3 days around Negros
Occidental and it will take 4-6 days Nationwide.
</p>
				<hr>
